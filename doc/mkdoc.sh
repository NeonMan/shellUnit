...
mkdoc () {
  ...
  CMD="cat ./sample-01/sample-01.shu"
  mkshrow "$CMD" "$TXT"
  ...
  C2=""
  mkrow "$C1" "$C2"
  C1="shunit ./sample-01/sample-01.shu"
  mkshrow "$C1"
  ...
  CMD="cat ./sample-02/sample-02.shu"
  mkshrow "$CMD" "$TXT"

  TXT="The sample target file:"
  CMD="cat ./sample-02/target.sh"
  mkshrow "$CMD" "$TXT"

  TXT="The output of shunit ./sample-02/"
  CMD="shunit ./sample-02"
  mkshrow "$CMD" "$TXT"
  ...
  CMD="cat ./sample-03/basic-asserts.shu"
  mkshrow "$CMD" "$TXT"

  TXT="The result of executing this test file is:"
  CMD="shunit ./sample-03/basic-asserts.shu"
  mkshrow "$CMD" "$TXT"
  ...
  CMD="cat ./sample-04/return-sample.shu"
  mkshrow "$CMD" "$TXT"
  ...
  CMD="shunit ./sample-04/return-sample.shu"
  mkshrow "$CMD" "$TXT"
  ...
  CMD="shunit --raw ./sample-03/basic-asserts.shu"
